...
function App() {
  ...
  const [difficulty, setDifficulty] = useState(null); // default difficulty level
  const [gameKey, setGameKey] = useState(false); // key to force re-render of GameArea component
